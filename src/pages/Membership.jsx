              ...
              <div className="relative z-10">
                ...
                <div className="mt-16 flex justify-center">
                  <RadioGroup
                    ...
                    className="grid grid-cols-2 gap-x-1 rounded-full bg-gray-500/50 p-1 text-center text-xs font-semibold leading-5 text-white"
                  >
                                        ...
                                        {typeof feature.tiers[tier.name] === 'string' ? (
                                          ...
                                          <>
                                            {feature.tiers[tier.name] === true ? (
                                              ...
                                              <XMarkIconMini
                                                className="mx-auto h-5 w-5 text-blue-400"
                                                aria-hidden="true"
                                              />
                                            )}
