...
function ContactUs() {
  ...
  return (
   <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80dbff8c] to-[#0068f0] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-gradient-to-tl from-cyan-400 via-blue-500 to-blue-600 drop-shadow-lg px-3.5 py-3.5 text-center text-md font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
            Let's talk
          </button>
        </div>
